...
void MapWidget::wheelEvent(QWheelEvent * e)
{
  ...
  // https://doc-snapshots.qt.io/qt6-dev/qwheelevent.html#angleDelta
  // angleDelta() returns in eighths of a degree.
  m_framework.Scale(exp(e->angleDelta().y() / 8.0 / 360.0), m2::PointD(L2D(pos.x()), L2D(pos.y())), false);
}
